...
// Funkcja zwraca tylko macierz po eliminacji Gaussa
vector<vector<double>> gaussianElimination(vector<vector<double>> mat)
{
    ...
    if (singular_flag != -1)
    {
        ...
        return mat; // zwracamy macierz nawet jeśli osobliwa
    }
    ...
    return mat; // zwracamy macierz po eliminacji
}